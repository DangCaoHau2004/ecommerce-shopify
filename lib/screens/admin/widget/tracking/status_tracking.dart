...
class StatusTrackingAdmin extends ConsumerStatefulWidget {
  const StatusTrackingAdmin({super.key, required this.type});
  final String type;

  @override
  ConsumerState<StatusTrackingAdmin> createState() =>
      _StatusTrackingAdminState();
}

class _StatusTrackingAdminState extends ConsumerState<StatusTrackingAdmin> {
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => DetailTrackingAdmin(
